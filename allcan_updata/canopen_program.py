...
class CANopenBinaryRunner(ZephyrBinaryRunner):
    ...
    def __init__(self, cfg, dev_id, can_bustype, can_channel, can_bitrate, can_context=DEFAULT_CAN_CONTEXT,
...
class CANopenProgramDownloader(object):
    ...
    def __init__(self, logger, node_id, can_bustype, can_channel, can_bitrate,
    ...
    def connect(self):
        ...
        try:
            ...
            # self.network.connect(bustype='slcan', channel='/dev/tty.usbmodem141101', bitrate=1000000)
            self.network.connect(bustype=self.can_bustype, channel=self.can_channel, bitrate=self.can_bitrate)
        except:
            print('Unable to connect to CAN network')
    ...
    def enter_pre_operational(self):
        ...
        try:
            ...
            print('Failed to enter pre-operational mode')
    ...
    def swid(self):
        ...
        print('Program software identification: 0x{:08x}'.format(swid))
    ...
    def download(self, bin_file):
        ...
        print('Downloading program: %s' % bin_file)
        try:
    ...
    def wait_for_bootup(self, timeout=DEFAULT_TIMEOUT):
        ...
        print('Waiting for boot-up message...')
    ...
    def wait_for_flash_status_ok(self, timeout=DEFAULT_TIMEOUT):
        ...
        print('Waiting for flash status ok')
